"""
Django settings for urdt_project project.
...
SECRET_KEY = 'django-insecure-skq%m(ixf@7)do5c*87r8y+_q+ozpt)z($e!a635iykivm$til'
...
MIDDLEWARE = [
    ...
    'urdt_app.audit_middleware.AuditMiddleware', 
]

ROOT_URLCONF = 'urdt_project.urls'
...
WSGI_APPLICATION = 'urdt_project.wsgi.application'
